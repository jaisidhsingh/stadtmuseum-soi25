...
import TueAILogo from "@/assets/logo-tueai.svg";
    ...
    <div className="h-full min-h-0 exhibit-shell flex flex-col overflow-hidden overflow-x-hidden px-4 py-4 md:px-8 md:py-7">
      <div className="mb-4 flex items-center justify-between gap-3">
        {!isShareLocked ? (
          <Button
            size="xl"
            className="gap-2 !text-lg md:!text-xl font-bold uppercase tracking-wide !text-white cta-step-3"
      ...
      <header className="exhibit-panel mb-4 rounded-2xl p-4 md:p-6">
        <h1 className="exhibit-title text-3xl md:text-5xl font-bold uppercase tracking-wide">
          {t("Share Your Artwork", "Kunstwerk teilen")}
        </h1>
        <p className="mt-2 text-xl text-foreground/90 md:text-3xl font-medium">
          {t(
      ...
      <div className="grid flex-1 min-h-0 grid-cols-1 gap-4 xl:grid-cols-[minmax(0,1fr)_390px]">
        <section className="exhibit-panel flex min-h-0 flex-col rounded-2xl p-4 md:p-5">
          <div className="mb-3 flex items-center justify-between gap-3">
            ...
            <span className="rounded-full bg-film-blue/10 px-4 py-1.5 text-lg font-semibold text-film-blue">
          ...
          {isProcessing ? (
            ...
            <div className="flex flex-1 flex-col items-center justify-center gap-4 rounded-2xl border border-dashed border-border bg-muted/40 p-6 text-center">
              ...
              {!isShareLocked ? (
                <Button onClick={() => navigate("/selection")} size="xl" className="!text-xl md:!text-2xl font-bold uppercase tracking-wide !text-white cta-step-3 mt-4">
        ...
        <aside className="exhibit-panel flex min-h-0 flex-col rounded-2xl p-4 md:p-5">
          {!shareInfo ? (
            <>
              ...
              <p className="mt-2 text-lg text-muted-foreground md:text-xl font-medium">
                {t(
